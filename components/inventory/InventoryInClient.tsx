    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center gap-2 justify-between">
        <Input
          ...
          placeholder="Tìm theo số lô hoặc loại nhân..."
      ...
      <div className="hidden md:block rounded-lg border bg-white overflow-hidden">
        <div className="grid grid-cols-7 gap-2 px-3 py-2 text-xs font-semibold text-gray-500 border-b bg-gray-50">
          <div>Ngày nhập</div>
          <div>Số lô</div>
          <div className="col-span-2">Loại nhân</div>
